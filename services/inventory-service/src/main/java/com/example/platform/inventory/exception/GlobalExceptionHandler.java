...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler({SkuAlreadyExistsException.class, InsufficientStockException.class,
            InvalidReleaseException.class, InvalidFulfillmentException.class,
            ReservedStockException.class})
    public ResponseEntity<ApiError> handleConflict(RuntimeException ex, HttpServletRequest request) {
        return build(HttpStatus.CONFLICT, ex.getMessage(), request, List.of());
    }

    @ExceptionHandler(InvalidStockQuantityException.class)
    public ResponseEntity<ApiError> handleInvalidStockQuantity(InvalidStockQuantityException ex,
