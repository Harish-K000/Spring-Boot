...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler({InvalidOrderStateException.class, CheckoutRejectedException.class,
            IdempotencyConflictException.class, CheckoutManagedOrderException.class})
    public ResponseEntity<ApiError> handleConflict(RuntimeException ex, HttpServletRequest request) {
        return build(HttpStatus.CONFLICT, ex.getMessage(), request, List.of());
    }

    @ExceptionHandler(CheckoutDependencyException.class)
    public ResponseEntity<ApiError> handleDependency(CheckoutDependencyException ex,
